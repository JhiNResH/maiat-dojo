...
export const AGENT_SERVICE_CARDS: AgentServiceCard[] = [
  {
    ...
    summary:
      "The Genesis SLL-R NFA. It owns the original seller-service abilities that Raposa, SOLYD, and future merchant agents can fork into their own service cards.",
